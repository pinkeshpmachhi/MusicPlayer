...
public class AlbumDetailAdapter extends RecyclerView.Adapter<AlbumDetailAdapter.MyViewHolder> {
    ...
    public AlbumDetailAdapter(Context context, ArrayList<MusicFiles> list, onClickInterface onClickInterface1) {
    ...
    @NonNull
    @Override
    public AlbumDetailAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sample_song_item, parent, false);
        return new AlbumDetailAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AlbumDetailAdapter.MyViewHolder holder, int position) {
