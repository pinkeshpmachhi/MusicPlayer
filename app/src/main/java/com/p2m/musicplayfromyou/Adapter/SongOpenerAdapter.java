...
public class SongOpenerAdapter extends RecyclerView.Adapter<SongOpenerAdapter.MyViewHolder> {

    private ArrayList<albumModel> list;
    private Context context;

    public SongOpenerAdapter(ArrayList<albumModel> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.song_opener_sample_item, parent, false);
